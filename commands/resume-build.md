...
Follow `skills/resume-build/SKILL.md` and `shared/ats-rules.md`.
...
Then fill `shared/resume-html/resume-template.html` and render with
`scripts/render_pdf.py` to a single-column ATS-safe PDF (only output format).
